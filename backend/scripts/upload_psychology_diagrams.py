#!/usr/bin/env python3
"""Upload AQA Psychology diagrams from docs/ to S3 and verify lesson URLs match."""
...
# "1.2.6 - 4.png" -> "diagrams/psychology/1.2.6-4.png"
...
def _s3_key(filename: str) -> str | None:
    ...
    if not m:
        return None
    return f"diagrams/psychology/{m.group(1)}-{m.group(2)}.png"
